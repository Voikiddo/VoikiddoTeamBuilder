...
const PlayerDiv = () => {
    ...
    const onChangeQuery = e => { 
        switch(e.target.value.toLowerCase()) {
            ...
            case "streamers": e.target.value = "(Voikiddo was watching those people's stream while having a mental breakdown: HammSamich & CarterCxter)"; break;
            case "voikiddo": e.target.value = "(You caught me! Wanna know what am I doing?)"; break;
